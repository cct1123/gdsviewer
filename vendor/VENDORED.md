...
- Adapted code: `../liquid_glass.js`. The bevel-dependent refraction and channel
  ...
  pointer lighting, event scheduling, and resource cleanup
...
The original CSS surface and inset highlights in `../index.html` were adapted from
...
The current styling retains the surface treatment and removes the inset highlight
layers; the historical attribution and license notice remain included.
